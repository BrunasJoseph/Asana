    ...
    public class ToDoServiceProxy
    {
        ...
        private ToDoServiceProxy()
        {
            ToDos = new List<ToDo>
            {
                ...
                new ToDo{Id = 2, Name = "Task 2", Description = "My Task 2", IsCompleted=false, DueDate = new DateTime(2025, 7, 25) },
                new ToDo{Id = 3, Name = "Task 3", Description = "My Task 3", IsCompleted=true, DueDate = new DateTime(2025, 8, 1) },
                new ToDo{Id = 4, Name = "Task 4", Description = "My Task 4", IsCompleted=false, DueDate = new DateTime(2025, 8, 5)},
                new ToDo{Id = 5, Name = "Task 5", Description = "My Task 5", IsCompleted=true, DueDate = new DateTime(2025, 8, 10) }
            };
        }
